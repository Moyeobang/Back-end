...
<html lang="en">
        ...
        <tbody>
          ...
          <input id="userid" name="userid" value="${userinfo.userId}" type="hidden" readonly></input>
           <input id="userpwd" name="userpwd" value="${userinfo.userPwd}" type="hidden" readonly></input>
            <td>신규 비밀번호</td>
            <td><input id="newpwd" name="newpwd" type="password" value=""/></td>
          </tr>
          <tr>
            <td>비밀번호 확인</td>
            <td><input id="confirmpwd" name="confirmpwd" type="password" value=""/></td>
          </tr>    
        </tbody>
      </table>
      </form>
  ...
  document.querySelector("#change").addEventListener("click", function () {
	  if(document.querySelector("#newpwd").value==document.querySelector("#confirmpwd").value){
